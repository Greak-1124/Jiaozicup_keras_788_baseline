...
class Make_data(object):
    ...
    def load_dataset(self):
        ...
        train['acc_all'] = (train.acc_x ** 2 + train.acc_y ** 2 + train.acc_z ** 2) ** .5
        train['acc_allg'] = (train.acc_xg ** 2 + train.acc_yg ** 2 + train.acc_zg ** 2) ** .5

        test['acc_all'] = (test.acc_x ** 2 + test.acc_y ** 2 + test.acc_z ** 2) ** .5
        test['acc_allg'] = (test.acc_xg ** 2 + test.acc_yg ** 2 + test.acc_zg ** 2) ** .5
